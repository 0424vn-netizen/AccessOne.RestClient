...
namespace VW.Api.RestClient.Providers
{
    /// <summary>
    ...
    public class CustomAuthenticator : IAuthenticator
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="T:VW.Api.RestClient.Providers.CustomAuthenticator"/> class.</summary>
