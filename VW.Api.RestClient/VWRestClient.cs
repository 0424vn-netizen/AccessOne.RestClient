...
using VW.Api.RestClient.Serializers;
...
namespace VW.Api.RestClient
{
    ...
    /// </summary>
    /// <seealso cref="IVWRestClient" />
    public abstract class VWRestClient : IVWRestClient
    {
        #region Properties
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VWRestClient" /> class.
        /// </summary>
        ...
        public VWRestClient(ILogger logger, ILoggingService loggingService, string source, string settingFile, RestClientSettings restClientSettings)
        {
            this.Logger = logger;
